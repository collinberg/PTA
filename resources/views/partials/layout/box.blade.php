<div class='news-card w-full md:mx-5 mb-5 items-stretch relative lg:flex-1 lg:max-w-1/3' data-loop='{!! $loop->index !!}'>
  <a href="{!! $permalink !!}" class='' title="Read more about {!! $item['title'] !!}">
    <img src="{!! $thumbnail !!}" alt="{!! $title !!}" class='w-full' width="100%" height="auto" alt="{!! $title !!}"/>
  </a>
  <div class="pt-5 mb-5">
    <time class='text-grey-darker mb-1 uppercase font-bold block text-sm'>{!! $time !!}</time>
