<header class="banner absolute w-full" aria-label="Main Navigation">
  <div class="px-8 mx-auto">
    <div class='flex items-start'>
      ...
      <div class='pt-5 flex w-1/5 hidden lg:block'>
        <a href="/donate" class='btn btn-secondary'>Donate</a>
        <button id='searchToggle' class="desktop-search-toggle lg:pl-2" data-search-toggle="closed" aria-label="Search Button">
